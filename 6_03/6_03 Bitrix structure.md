...
4. Дать доступ к админке группе пользователей "Редактор новостей" (права доступа к админке настраиваются как права доступа к папке "/bitrix/admin");
5. Дать доступ к медиабиблиотеке группе пользователей "Редактор новостей" (права доступа к медиабиблиотеке настраиваются в самой медиабиблиотеке, кнопка "Доступ" вверху);
